...
export default function App() {
  ...
  useEffect(() => { loadCardsFromSupabase(); }, []);
              ...
              {adminTab==="settings"&&(
                <div>
                  ...
                  <div style={{ padding:"12px 14px",background:C.red+"10",border:`1px solid ${C.red}30`,borderRadius:10 }}>
                    ...
                    <button style={{ ...S.btn(C.red),fontSize:12,padding:"8px 14px" }} onClick={()=>{if(window.confirm("Бүгдийг устгах уу?")){["posts_v4","u_db_v4","premium_codes_v4","rp_v4","bs_v4","arc_v4","xp_v4","ms_v4"].forEach(k=>localStorage.removeItem(k));window.location.reload();}}}>Бүх өгөгдлийг устгах</button>
                  </div>
                </div>
              )}
            </div>
