        ...
        {!adminAuth?(
          ...
          <>
            ...
            <div style={{ padding:20 }}>
              ...
              {adminTab==="settings"&&(
                <div>
                  <div style={{ ...S.surface,marginBottom:16,background:C.accent+"15",border:`1px solid ${C.accent}40` }}>
                    <h3 style={{ margin:"0 0 10px",fontSize:14,color:C.accentL }}>🧪 Edge Function тест</h3>
                    <p style={{ fontSize:12,color:C.muted,margin:"0 0 10px" }}>Энэ товчийг дарж Edge Function ажиллаж байгаа эсэхийг шалгана уу. Console-г нээгээрэй (Cmd+Option+J)</p>
                    <button style={{ ...S.btn(C.accent),padding:"8px 16px",fontSize:13 }} onClick={testAdminFunction}>
                      🧪 Test admin function
                    </button>
                  </div>
